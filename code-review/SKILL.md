...
Read `docs/agents/issue-tracker.md` when present. Without an explicit tracker configuration, resolve specs and tickets from Local Markdown under `.scratch/`; a GitHub remote alone never selects GitHub Issues.

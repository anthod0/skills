...
Writing guidance lives in `src/lib/server/prompts/reply.ts`. The tests cover request validation, failed-generation recovery, and message separation without calling OpenAI.
